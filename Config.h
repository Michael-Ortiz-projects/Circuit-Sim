...
inline constexpr int simBackgroundColorDepth = 90;
...
inline sf::Color simulationWindowBackgroundColor = sf::Color(simBackgroundColorDepth, simBackgroundColorDepth, simBackgroundColorDepth, 255);
