...
class VoltageControlledVoltageSource : public SimulationComponent {

public:
	VoltageControlledVoltageSource(int a, int b, int c, int d, double k, int id, std::string Label)
